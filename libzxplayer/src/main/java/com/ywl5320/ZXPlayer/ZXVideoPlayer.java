...
public class ZXVideoPlayer {
    ...
    public void setZXGlSurfaceView(ZXGlSurfaceView glSurfaceView) {
        this.glSurfaceView = glSurfaceView;
        glSurfaceView.setOnGlSurfaceViewOncreateListener(new WlOnGlSurfaceViewOncreateListener() {
            @Override
